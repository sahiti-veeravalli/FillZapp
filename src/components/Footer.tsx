...
const Doodles = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Squiggle top-left */}
    <svg className="absolute top-8 left-[5%] w-28 h-16 text-primary-foreground/[0.07]" viewBox="0 0 120 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
      <path d="M5 25 Q20 5, 35 25 T65 25 T95 25 T115 25" />
    </svg>
    {/* Star top-right */}
    <svg className="absolute top-12 right-[8%] w-10 h-10 text-primary-foreground/[0.08]" viewBox="0 0 40 40" fill="currentColor">
      <path d="M20 2l4.5 13.8H39l-11.7 8.5 4.5 13.8L20 29.6 8.3 38.1l4.5-13.8L1 15.8h14.5z" />
    </svg>
    {/* Circle doodle mid-left */}
    <svg className="absolute top-1/3 left-[3%] w-14 h-14 text-primary-foreground/[0.06]" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
      <circle cx="25" cy="25" r="20" strokeDasharray="6 8" />
    </svg>
    {/* Arrow doodle mid-right */}
    <svg className="absolute top-1/4 right-[12%] w-20 h-12 text-primary-foreground/[0.07]" viewBox="0 0 80 40" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 20 Q25 5, 45 20 T75 15" />
      <path d="M65 8 L75 15 L65 22" />
    </svg>
    {/* Lightning bolt bottom-left */}
    <svg className="absolute bottom-[20%] left-[10%] w-8 h-14 text-primary-foreground/[0.08]" viewBox="0 0 30 55" fill="currentColor">
      <path d="M18 0L5 25h10L8 55l20-30H17z" />
    </svg>
    {/* Dots cluster center-left */}
    <svg className="absolute top-[55%] left-[25%] w-16 h-16 text-primary-foreground/[0.06]" viewBox="0 0 60 60" fill="currentColor">
    ...
    {/* Spiral bottom-right */}
    <svg className="absolute bottom-[15%] right-[6%] w-16 h-16 text-primary-foreground/[0.07]" viewBox="0 0 60 60" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
    ...
    <svg className="absolute top-16 left-[45%] w-8 h-8 text-primary-foreground/[0.08]" viewBox="0 0 30 30" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round">
      <line x1="15" y1="5" x2="15" y2="25" /><line x1="5" y1="15" x2="25" y2="15" />
    </svg>
    {/* Wavy line bottom */}
    <svg className="absolute bottom-[30%] left-[40%] w-32 h-10 text-primary-foreground/[0.06]" viewBox="0 0 130 30" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
      <path d="M5 15 Q20 0, 35 15 T65 15 T95 15 T125 15" />
    </svg>
    {/* Diamond right-center */}
    <svg className="absolute top-[45%] right-[20%] w-10 h-10 text-primary-foreground/[0.07]" viewBox="0 0 40 40" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round">
      <path d="M20 5 L35 20 L20 35 L5 20 Z" />
    </svg>
    {/* Small star bottom-center */}
    <svg className="absolute bottom-[8%] left-[55%] w-7 h-7 text-primary-foreground/[0.09]" viewBox="0 0 30 30" fill="currentColor">
