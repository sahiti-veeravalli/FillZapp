...
import { User, UserCircle, Briefcase, GraduationCap, FileText, PlusCircle, Settings, Zap, LogOut, PanelLeftClose, Tag, IdCard, CreditCard, MapPin, Globe, Target } from "lucide-react";
...
const DashboardSidebar = ({ activeTab, onTabChange, onClose, customFields = [] }: DashboardSidebarProps) => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-sidebar border-r border-sidebar-border flex flex-col">
      <button onClick={() => navigate("/")} className="p-6 flex items-center gap-3 hover:opacity-80 transition-opacity group">
