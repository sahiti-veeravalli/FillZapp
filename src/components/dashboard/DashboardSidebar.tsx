...
import { User, UserCircle, Briefcase, GraduationCap, FileText, PlusCircle, Settings, Zap, LogOut, ChevronLeft, Tag, IdCard, CreditCard, MapPin, Globe, Target, Bookmark } from "lucide-react";
  ...
  return (
    <aside className="w-64 min-h-screen bg-sidebar border-r border-sidebar-border flex flex-col">
      ...
      <div className="p-5 flex items-center justify-between">
        ...
        <button
          onClick={onClose}
          className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary hover:bg-primary/20 hover:shadow-[0_0_12px_hsl(var(--primary)/0.3)] transition-all duration-300"
          title="Close sidebar"
        >
