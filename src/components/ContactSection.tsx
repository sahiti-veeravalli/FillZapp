      ...
      <div className="section-container">
        ...
        >
          <p className="flex items-center justify-center gap-4 text-muted-foreground text-2xl">
            developed by{" "}
            <span style={{ fontFamily: "'Playfair Display', serif" }} className="text-primary font-bold italic text-6xl">Sahiti</span>{" "}
            <span style={{ fontFamily: "'Playfair Display', serif" }} className="text-foreground font-bold italic text-6xl">Veeravalli</span>
