      ...
      <div className="section-container">
        ...
        >
          <p className="flex items-center justify-center gap-1.5 text-muted-foreground text-xs">
            developed by{" "}
            <span style={{ fontFamily: "'Playfair Display', serif" }} className="text-primary font-bold italic text-sm">Sahiti</span>{" "}
            <span style={{ fontFamily: "'Playfair Display', serif" }} className="text-foreground font-bold italic text-sm">Veeravalli</span>
